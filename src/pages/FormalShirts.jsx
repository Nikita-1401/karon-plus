          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-1.5">
              ...
              <div className="flex items-center gap-2 text-[10px] font-bold tracking-[0.18em]">
                ...
                <span className="text-[#a85e16]">FORMAL</span>
              </div>
            </div>
            ...
            <article key={product.id} className="group min-w-0">
              <div className="relative overflow-hidden bg-[#d8cfc3] h-[315px] sm:h-[270px] lg:h-[270px] xl:h-[280px]">
                ...
                <Link
                  ...
                  className="hidden lg:flex absolute right-3 bottom-3 h-9 px-4 bg-[#f8f4ed] text-[#171714] items-center gap-2 text-[9px] font-bold tracking-[0.12em] opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300"
                >
                  VIEW
                  <FiArrowRight size={11} />
                </Link>
